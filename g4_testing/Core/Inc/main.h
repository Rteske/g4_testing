...
/* Private defines -----------------------------------------------------------*/
#define SEN_INT1_Pin GPIO_PIN_4
#define SEN_INT1_GPIO_Port GPIOA
#define SEN_INT1_EXTI_IRQn EXTI4_IRQn
#define SEN_EN1_Pin GPIO_PIN_0
#define SEN_EN1_GPIO_Port GPIOB
#define A121_SPI_SS_Pin GPIO_PIN_1
#define A121_SPI_SS_GPIO_Port GPIOB
#define SPI_SEL0_Pin GPIO_PIN_5
#define SPI_SEL0_GPIO_Port GPIOB
#define SPI_SEL1_Pin GPIO_PIN_6
#define SPI_SEL1_GPIO_Port GPIOB
#define SPI_SEL2_Pin GPIO_PIN_7
